...
class User(Base):
    ...
    login_identifier: Mapped[str | None] = mapped_column(String(50), unique=True, index=True)
    identity_type: Mapped[str] = mapped_column(String(20), default="student", nullable=False)
    nim: Mapped[str | None] = mapped_column(String(30), unique=True)
    nip: Mapped[str | None] = mapped_column(String(30), unique=True)
